        ...
        <div class="form-group row">
          ...
          <div class="col-sm-9">
            ...
            <strong class="form-text <!--text-muted--> mt-2">Мы не показываем последние четыре цифры паспорта другим
              копникам. Это информация проверяется только во время подтверждения регистрации. Подробнее в ролике внизу страницы "Зачем нужно заверять регистрацию".</strong>
          </div>
        </div>
      </fieldset>
...
<!--      <div class="" style="margin-bottom: 2em">
        <label class="form-check-label text-justify">
          ...
          Я предоставляю Администрации “kopnik.org” бессрочное право на обработку моих персональных данных,
          включая их сбор, систематизацию, накопление, хранение на бумажном и электронном носителях,
          уточнение (обновление, изменение), использование, передачу по запросу правоохранительные органы,
          отображение внутри kopnik.org
        </label>
      </div>-->
      ...
      <div class="alert alert-danger" v-if="submited && !model.isReady() && !model.id">
        ...
        <ul class="list-unstyled2">
          ...
          <li v-if="!agreement">Не дано согласие на обработку персональных данных</li>
        </ul>
      ...
      <div v-if="model.id" class="alert alert-success" role="alert">
        ...
        <p class="font-weight-bold">
          ...
          учетных записей и голосование на копах несколькими голосами. Подробнее в ролике внизу страницы "Зачем нужно заверять регистрацию".
