    ...
    <form class="row">
      <div class="col-10 col-sm-7 col-md-5 col-lg-4 mx-auto">
        ...
        <div class="w-100 text-justify">
          Друзья, наш проект испытывает административный и финансовый голод. Нам требуются:
          <ul>
            <li>системные администраторы</li>
            <li>администраторы баз данных</li>
            <li>frontend-разработчики JavaScript</li>
            <li>backend-разработчики JavaScript</li>
            <li>администраторы социальных групп</li>
            <li>специалисты по продвижению и рекламе</li>
            <li>юристы</li>
            <li>организаторы</li>
            <li>финасы на поддержание всго вышеперечисленного</li>
          </ul>

          <div>
            Если вы обладаете навками и желанием принимать участие, свяжитесь с нами в наших группах Вконтакте и Телеграм.
            Мира и добра всем, кто поддерживает идеи объединения русского мира на принципах копного права.
          </div>
        </div>
<!--
...
-->
        <div class="text-muted my-4 text-justify">
          ...
          <!--<div class="text-center lead ">Пока мы едины, мы непобедимы!</div>-->
          Мы возраждаем копное право в России, Украине, Беларуси, Польше, Сербии, Чехии и до самых краёв русского мира.
        </div>
      </div>
